...
"""ground"""
ground = cylinder(pos = vector(mass.pos.x,0,0),axis = vector(5,0,0),radius = 0.1,color = color.black)
"""Run button"""
running = False
def Run(b):
    global mass,running
